...
- [x] Gestão de Escolas: excluir todas as escolas de um técnico específico
- [x] Gestão de Escolas: seleção múltipla de escolas para exclusão em lote
- [x] Gestão de Escolas: modal de edição completa (nome, INEP, município, UF, endereço, coordenadas, telefone)
